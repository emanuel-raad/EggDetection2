...
#import xlsxwriter
#
#workbook = xlsxwriter.Workbook('Bird Count.xlsx')
...
### show results
print 'Number of birds = ' + str(len(count))
cv2.imshow('frame', img)

#saving the image for the birdcount
cv2.imwrite('birdcount.png',img)

#worksheet.set_column('A:A', 15)
#worksheet.write('A1', 'Number of Birds', bold)
#worksheet.write('B1', len(count))
#worksheet.insert_image('C4', 'birdcount.png')
#
#
#workbook.close()
cv2.waitKey(0)
